...
from blast_rest.features.record import Alignment, BlastRecord, Hsp
...
def blast_records_to_object(blast_records):
    """Transforms biopython's blast record into blast object defined in  app.  """
...
def run_blast_commands(ncbicommandline_method, **keywords):
    ...
    query_file_object_tmp.read()
    stderr = ''
    error_string = ''
    try:
        # formating blast command
        blastx_cline = ncbicommandline_method(**keywords)
